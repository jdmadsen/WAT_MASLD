...
```{r chunk 1}
seurat_common <- qread("/work/WAT_MASLD/Data/seurat_object.qs")
```

```{r chunk 1}
seurat_common_with_ambientremoval <- qread("/work/WAT_MASLD/Data/seurat_object_annotated_ambientRNAremoval.qs")
...
#qsave(seurat_common_filtered ,"/work/WAT_MASLD/Data/filtered_seurat_object.qs")
```
